                      ...
                      children: [
                        ...
                        Expanded(child: SingleChildScrollView(
                          child: GetBuilder<AuthController>(
                              builder: (weeklyylisttdata) {
                            if (weeklyylisttdata.isLoading.value &&
                                weeklyylisttdata.weeklydietlistdataa.isEmpty) {
                              return Center(child: CustomLoadingIndicator());
                            } else if (weeklyylisttdata
                                .weeklydietlistdataa.isEmpty) {
                              return const Center(
                                  child: Padding(
                              ...
                              return Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...weeklyylisttdata.weeklydietlistdataa
                                        .asMap()
                                        .entries
                                        .map((e) {
                                      return Padding(
  ...
  Future<void> detoxxdiett(BuildContext context) async {
    ...
    if (templetee.isEmpty) {
      ...
      try {
        ...
        Get.find<AuthController>().weeklyyypostapiiii(
