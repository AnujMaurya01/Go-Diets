...
class CodeTemplaescreen extends StatefulWidget {
  const CodeTemplaescreen({super.key});

  @override
  State<CodeTemplaescreen> createState() => _CodeTemplaescreenState();
}

class _CodeTemplaescreenState extends State<CodeTemplaescreen> {
                          ...
                          child: Container(
                            child: SingleChildScrollView(child:
                                GetBuilder<AuthController>(
                                    builder: (codetempletlisttdata) {
                              if (codetempletlisttdata.isLoading.value &&
                                  codetempletlisttdata
                                      .codetempletelistdataa.isEmpty) {
                                return Center(child: CustomLoadingIndicator());
                              } else if (codetempletlisttdata
                                  .codetempletelistdataa.isEmpty) {
                                return const Center(
                                    child: Padding(
  ...
  Future<void> detoxxdiett(BuildContext context) async {
    ...
    if (templetee.isEmpty) {
      ...
      try {
        ...
        Get.find<AuthController>().codetempletepostapiiii(
