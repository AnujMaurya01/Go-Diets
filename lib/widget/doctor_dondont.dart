...
class DoctorDondontScreen extends StatefulWidget {
  String? puseridd;
  String? username;
  DoctorDondontScreen({super.key, this.puseridd, this.username});

  @override
  State<DoctorDondontScreen> createState() => _DoctorDondontScreenState();
}

class _DoctorDondontScreenState extends State<DoctorDondontScreen> {
          ...
          : Column(
              children: [
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              margin:
                                  EdgeInsets.only(left: 0, right: 30, top: 20),
                              height: 35,
                              width: 100,
                ...
                Expanded(child: SingleChildScrollView(
                  child:
                      GetBuilder<AuthController>(builder: (dontodnttlissddts) {
                    if (dontodnttlissddts.isLoading.value &&
                        dontodnttlissddts.doctordontlidtdataa.isEmpty) {
                      return Center(child: CustomLoadingIndicator());
                    } else if (dontodnttlissddts.doctordontlidtdataa.isEmpty) {
                      return const Center(
                          child: Padding(
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...dontodnttlissddts.doctordontlidtdataa
                                .asMap()
                                .entries
                                .map((e) {
  ...
  Future<void> detoxxdiett(
    BuildContext context,
  ) async {
    String temolete = templateenameController.text.trim();
    if (temolete.isEmpty) {
      setState(() {
        passwordError = true;
      });
      ...
      try {
        ...
        Get.find<AuthController>().doctordonndonttt(
            answer: '',
            question: temolete.trim(),
            puseridd: widget.puseridd,
            context: context);
        setState(() {
          isLoading = false;
