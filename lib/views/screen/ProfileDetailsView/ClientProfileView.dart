...
class _ProfileViewDetailsState extends State<ProfileViewDetails> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(logic.profileDetails!.name!,
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                          child: Text(
                                              logic.profileDetails!.bloodGroup!,
                                              style: poppinsSemiBold.copyWith(
                                                  fontSize: 12,
                                                  height: 1,
                                                  color: ColorResources
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      //color: Colors.grey,
                                      child: Text(
                                          logic.profileDetails!.medicalProblem!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      //color: Colors.grey,
                                      child: Text(
                                          logic.profileDetails!.anyFoodAllergy!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      //color: Colors.grey,
                                      child: Text(
                                          logic.profileDetails!.eatingPattern!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      width: Get.width,
                                      //color: Colors.grey,
                                      child: Text(logic.profileDetails!.lunch!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      width: Get.width,
                                      //color: Colors.grey,
                                      child: Text(logic.profileDetails!.dinner!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
                              ...
                              if (logic.profileDetails!.gender == "Female") ...[
                                Padding(
                                    padding: const EdgeInsets.only(top: 8.0),
                                    child: Container(
                                        width: Get.width,
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      //color: Colors.grey,
                                      child: Text(
                                          logic.profileDetails!.alcoholIntake!,
                                          style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              height: 1,
                                              color: ColorResources
  ...
  Widget _buildAlertSlotSuccessDialog(
    ...
    if (profileDetails!.planPrice != null) {
      formattedNumber =
          NumberFormat('#,##0').format(double.parse(profileDetails.planPrice!));
    }
