...
class ChatUserHistoryNav extends StatefulWidget {
  const ChatUserHistoryNav({super.key});

  @override
  State<ChatUserHistoryNav> createState() => _ChatUserHistoryNavState();
}

class _ChatUserHistoryNavState extends State<ChatUserHistoryNav> {
    ...
    return Padding(
      ...
      child: GetBuilder<AuthController>(builder: (transactionHistory) {
        return Column(
            ...
            children: [
              ...transactionHistory.chatData.asMap().entries.map((e) {
