...
class ChatScreenHistory extends StatefulWidget {
  const ChatScreenHistory({super.key});

  @override
  State<ChatScreenHistory> createState() => _ChatScreenHistoryState();
}

class _ChatScreenHistoryState extends State<ChatScreenHistory> {
  bool isValid = false;
